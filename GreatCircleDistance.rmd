...
<<<<<<< HEAD
  r <- raster(harvest_pts,nrows=40, ncols=40)
=======
  r <- raster(harvest_pts, nrows=30, ncols=30)
>>>>>>> f7f80d1540e1c91f7c9fb6093ddb81d12c535294
...
```
### Cleaning the Data
It looks like a few outliers are having a big impact on the data, so I'll remove the top 1% and bottom 1% of values and get rid of the NA value prior to analyzing the dataset.
```{r remove_outliers}
